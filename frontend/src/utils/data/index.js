export const poseInstructions = {
  ...
  GoddessPose: [
    "Start in a comfortable position with your feet together and your hands on your hips. Keep your gaze forward and your head upright. Take a few deep breaths in and out.",
    "Begin to lift your hips up towards the ceiling, keeping your back straight and your shoulders relaxed. Keep your head up and your gaze forward. Take a deep breath in and out.",
    "Slowly lower your hips back down to the floor, keeping your back straight and your shoulders relaxed. Keep your head up and your gaze forward. Take a deep breath in and out.",
    "Repeat the process for the next pose.",
    "Source: yoga with adriene - https://www.yogawithadriene.com/poses/goddess-pose",
  ],
  No_Pose: ["No instructions available"],
};
...
export const customWorkouts = [
  ...
  "2. Choose from the poses and set the duration of the workout.",
  "3. Manage the poses in queue by dragging and dropping them to the desired order.",
  "4. Click on Create Workout and see the workout in the right side.",
  "5. Start the workout and follow the instructions.",
];
